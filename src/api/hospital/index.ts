...
import type { UserResponseData,DoctorResponseData,HospitalWordData,WXLoginResponseData, DepartmentResponseData, HospitalDetail, LoginData, UserLoginResponseData, DoctorInfoData } from "./type";
