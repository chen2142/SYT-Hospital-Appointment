<template>
    ...
    <el-card class="box-card">
        ...
        <el-pagination v-model:current-page="pageNo" v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 40]"
            ...
            :total="total" @current-change="getOrderInfo" @size-change="handler"/>
    </el-card>
</template>
...
// 引入ts类型
import {type UserOrderInfoResponseData,type Records, AllUser, AllUserResponseData, AllOrderState, AllOrderStateResponseData,} from '@/api/user/type.ts'
// 当前分页器页码
