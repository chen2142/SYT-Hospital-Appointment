        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="releasetime">
                    退号时间：就诊前一工作日{{ hospitalStore.hospitalInfo.bookingRule?.quitTime }}
                </div>
                <div class="rule">预约挂号规则</div>
                <div class="ruleInfo" v-for="(item,index) in hospitalStore.hospitalInfo.bookingRule?.rule" :key="index">{{ item }}</div>
            </div>
        </div>
        <!-- 展示科室数据 -->
...
// 点击科室按钮回调
// item:即为用户选中科室的数据
const showLogin = function(item:any){
