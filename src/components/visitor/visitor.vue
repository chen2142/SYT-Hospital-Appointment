    ...
    <div class="visitor">
        <div class="top">
            ...
            <div class="right">
                ...
                <el-popconfirm @confirm="removeUser" :title="`你确定要删除${user.name}吗`" width="200px">
                    <template #reference>
                        <el-button v-if="$route.path == '/user/patient'" circle type="primary" size="danger"
